...
import 'package:tut_app/data/repository/base_weather_repository.dart';
import 'package:tut_app/domain/entities/weather.dart';
import 'package:tut_app/domain/repository/weather_repository.dart';
import 'package:tut_app/domain/usecases/get_weather_by-country.dart';

void main() async{
  BaseRemoteDataSource baseRemoteDataSource = RemoteDataSource();
  BaseWeatherRepository baseWeatherRepository =
      WeatherRepository(baseRemoteDataSource);
 Weather weather = await GetWeatherByCountryName(baseWeatherRepository).execute("London");
  runApp(const MyApp());
}
